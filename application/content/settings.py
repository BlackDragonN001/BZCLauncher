...
class Settings(Content):
    def __init__(self, resource_manager):
        ...
        # Editor Check
        self.editor_check = widgets.CheckBox(resource_manager,"Editor (Multiplayer Disabled)", self.editor_toggled)
        ...
        # Windowed Mode
        self.windowed_check = widgets.CheckBox(resource_manager, "Windowed Mode", self.windowed_mode_toggled)
        ...
        # Nobody Home
        self.nobody_home_check = widgets.CheckBox(resource_manager, "Nobody Home (Blank BZN)", self.nobody_home_toggled)
        ...
        # Skip Intro
        self.skip_intro_check = widgets.CheckBox(resource_manager, "Skip Intro Movie", self.skip_intro_toggled)
        ...
        # No Script
        self.no_script_check = widgets.CheckBox(resource_manager, "No Script", self.no_script_toggled)
        ...
        # Power User Mode
        self.power_user_check = widgets.CheckBox(resource_manager, "Power User Mode", self.power_user_toggled)
        ...
        # Shell map
        self.shell_map_check = widgets.CheckBox(resource_manager, "Shell Map", self.shell_map_toggled)
        ...
        # Safe mode
        self.safe_mode_check = widgets.CheckBox(resource_manager, "Safe Mode (Reset Graphics)", self.safe_mode_toggled)
        ...
        # Snap Scrap
        self.snap_scrap_check = widgets.CheckBox(resource_manager, "Snap Scrap", self.snap_scrap_toggled)
        ...
        # No Vista
        self.no_vista_check = widgets.CheckBox(resource_manager, "No Vista (Don't use MyDocs)", self.no_vista_toggled)
        ...
        self.delete_aoi_check = widgets.CheckBox(resource_manager, "Delete AOI's on Load", self.aoi_mode_toggled)
